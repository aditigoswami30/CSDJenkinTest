...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "SpecFlowFeature1", "\tIn order to develop RPN calc\r\n\tAs a math idiot\r\n\tI want to be told the sum of tw" +
        ...
        public virtual void AddTwoNumbers(string num1, string num2, string op, string[] exampleTags)
        {
...
#line 10
 testRunner.And(string.Format("I have entered {0} into the calculator", op), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 11
 testRunner.When("I press Enter", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 12
 testRunner.Then(string.Format("the result should be {0} {1} {2} on the screen", num2, op, num1), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
